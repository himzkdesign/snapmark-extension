...
- **Feedback (bottom):** **`#btn-feedback`** — **36×36px** surface (**`#1a1a1a`**, **`1px #2a2a2a`** border, **8px** radius), **18px** question-mark **`#666`** (hover **`#fff`**, surface **`#252525`**, border **`#444`**); **“Help”** label (**9px** Geist Mono **`#555`**, hover **`#888`**); tooltip **“Give feedback”** after **400ms** (chip **`left: 76px`**, vertically centered on control); **`window.open(FEEDBACK_FORM_URL, '_blank')`**.
